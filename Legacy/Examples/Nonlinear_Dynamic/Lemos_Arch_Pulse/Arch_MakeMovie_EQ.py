...
for file_name in os.listdir():
    ...
    if file_name.endswith('0.25.h5') and file_name.startswith(f'NoTension_EQ_0.2g_NWK'):
...
for i in range(frames_needed):
    ...
    St.plot_structure(scale=25, plot_cf=False, plot_forces=False, show=False, save=saveto, lims=[[-5., 5.], [-.5, 5]])
...
clip.write_videofile(f'ARCH_EQ_0.2g.mp4', codec='libx264')
