...
with open(f'B_Arch_Coulomb.pkl', 'rb') as file:
    St = pickle.load(file)

file = 'TAN_LG_B_Coulomb_0.15g_0.05_NWK_g=0.5_b=0.25.h5'
...
for i in range(frames_needed):
    ...
    St.plot_structure(scale=10, plot_cf=False, plot_forces=False, show=False, save=saveto, lims=[[-5., 5.], [-.5, 5]])
...
clip.write_videofile(f'Video_NoTension_ARCH_{a}g.mp4', codec='libx264')
