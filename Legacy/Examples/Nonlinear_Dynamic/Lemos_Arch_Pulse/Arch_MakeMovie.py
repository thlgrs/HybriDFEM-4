...
for file_name in os.listdir():
    ...
    if file_name.endswith('0.25.h5') and file_name.startswith(f'NoTension_{a}g_0.05_NWK'):
        files.append(file_name)

files = ['TANF_NoTension_0.15g_0.05_NWK_g=0.5_b=0.25.h5']
...
for i in range(frames_needed):
    ...
    St.plot_structure(scale=1, plot_cf=False, plot_forces=False, show=False, save=saveto, lims=[[-5., 5.], [-.5, 5]])
...
clip.write_videofile(f'FVideo_NoTension_ARCH_{a}g.mp4', codec='libx264')
