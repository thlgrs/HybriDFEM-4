...
for i in range(frames_needed):
    ...
    St.plot_structure(scale=2, plot_cf=False, plot_forces=False, show=False, plot_supp=False, save=saveto,
                      lims=[[-1., 4.], [-.5, 3.5]])
...
clip.write_videofile(f'Frame_Damaged_{a}g.mp4', codec='libx264')
