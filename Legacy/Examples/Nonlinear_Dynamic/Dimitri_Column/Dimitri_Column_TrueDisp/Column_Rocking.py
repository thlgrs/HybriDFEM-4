...
plt.plot(time, Disp)
# %% Computation
St.impose_dyn_excitation(0, 0, Disp, dt)
St.set_damping_properties(xsi=0.00, damp_type='INIT')

# Meth=['HHT',.3]
Meth = 'CDM'
St.solve_dyn_nonlinear(t_end, dt, Meth=Meth, lmbda=None, filename=f't_p={t_p}_a={a}')
