...
print(error_c * 100, error_s * 100)

# plt.plot(cps, error_x*100, color='grey', linewidth=1,marker='o',label='$x$',markerfacecolor='white',markersize=3)
