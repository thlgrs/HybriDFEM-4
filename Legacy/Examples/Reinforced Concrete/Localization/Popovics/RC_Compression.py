...
CONCR = mat.popovics_concrete(fc, ec, ecu, n, ft, et, etu, b)
...
St.solve_dispcontrol(1000, 1e-3, BLOCKS - 1, 0, filename=f'Results_{BLOCKS}_T', tol=1e-2, max_iter=1000)
