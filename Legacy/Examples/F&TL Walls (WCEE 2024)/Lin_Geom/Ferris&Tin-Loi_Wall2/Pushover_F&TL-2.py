...
# LIST = np.append(LIST, np.linspace(LIST[-1], 5e-3, 1000))
...
St.solve_dispcontrol(LIST, 0, Node, 0, tol=1e-3, filename=f'Wall2_rb={r_b}_psi={psi}', max_iter=1000)
...
file = f'Wall2_rb={r_b}_psi={psi}.h5'
