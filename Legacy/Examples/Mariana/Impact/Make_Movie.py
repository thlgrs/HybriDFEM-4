...
with open(f'Structure.pkl', 'rb') as file:
    St = pickle.load(file)

files = ['W11_1_Impact_CDM_.h5']
...
for i in range(frames_needed):
    ...
    St.plot_structure(scale=2, plot_cf=False, plot_forces=False, show=False, save=saveto,
                      lims=[[-0.5, 0.5], [-0.2, 2.]])
...
clip.write_videofile(f'Video_Impact.mp4', codec='libx264')
