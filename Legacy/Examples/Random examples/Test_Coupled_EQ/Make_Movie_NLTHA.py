...
if fixed:
    filename = 'Response_NF13_NWK_g=0.5_b=0.25.h5'
    st_name = 'Composite_Frame.pkl'
    name = 'Fixed'
else:
    filename = 'Response_NF13_SSI_NWK_g=0.5_b=0.25.h5'
    name = 'Rocking'
    st_name = 'Composite_Frame_SSI.pkl'
...
clip.write_videofile('Video_' + name + zt + '.mp4', codec='libx264')
